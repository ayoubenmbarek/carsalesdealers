...
class CarsalesDealersSpider(scrapy.Spider):
        name = "carsalesdealersperdepartment0410"
        handle_httpstatus_list = [302, 301]#, 500]#, 403]
	...
	#change separator awk 'gsub(",",";")' latest5_carsales_2017_09_v4.csv
        def parse(self, response):
                ...
                for i in range(62,501):#find number of pages(496 all) 525 from2,46 #stopped in 279, last 345
